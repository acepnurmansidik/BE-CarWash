...
@section('title', 'Payment | Cuci Mobil AquWash')
@section('content')
    ...
    <div id="Order-details" class="flex flex-col gap-2 px-4 mt-[30px]">
      ...
      <div class="flex flex-col w-full rounded-2xl border border-[#E9E8ED] p-4 gap-4 bg-white">
        ...
        <div id="Price-details" class="flex flex-col gap-[10px]">
          ...
          <div class="flex items-center justify-between">
            <p class="text-sm leading-[21px]">PPN {{ $ppn * 100 }}%</p>
    ...
    <div class="flex h-full flex-1 mt-5">
      <form action="{{ route('front.booking.payment.store') }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col rounded-t-[30px] p-5 pt-[30px] gap-[26px] bg-white overflow-x-hidden mb-0 mt-auto">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="rounded-full flex items-center ring-1 ring-[#E9E8ED] p-[12px_16px] bg-white w-full transition-all duration-300 focus-within:ring-2 focus-within:ring-[#FF8E62] relative">
